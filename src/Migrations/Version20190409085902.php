...
final class Version20190409085902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE qa_components (id INT AUTO_INCREMENT NOT NULL, team_id INT NOT NULL, name VARCHAR(255) NOT NULL, child_components VARCHAR(1000) NOT NULL, first_lvl_hours INT NOT NULL, second_lvl_hours INT NOT NULL, third_lvl_hours INT NOT NULL, four_lvl_hours INT NOT NULL, five_lvl_hours INT NOT NULL, INDEX IDX_3D65778D296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
