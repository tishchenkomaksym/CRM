 ...
 */
final class Version20190607104742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE department_team_sdt_view_rules ADD team_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE department_team_sdt_view_rules DROP team_id');
    }
}
