...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DenyChoiceDepartmentRepository")
 */
class DenyChoiceDepartment
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\DenyReasonDepartment", mappedBy="denyChoiceDepartment")
     */
    ...
    public function addDenyReasonDepartment(DenyReasonDepartment $denyReasonDepartment): self
    {
        if (!$this->denyReasonDepartments->contains($denyReasonDepartment)) {
            ...
            $denyReasonDepartment->setDenyChoiceDepartment($this);
        }
    ...
    public function removeDenyReasonDepartment(DenyReasonDepartment $denyReasonDepartment): self
    {
        if ($this->denyReasonDepartments->contains($denyReasonDepartment)) {
            ...
            if ($denyReasonDepartment->getDenyChoiceDepartment() === $this) {
                $denyReasonDepartment->setDenyChoiceDepartment(null);
            }
        }
